...
function themNhom(){
	...
	var nhom = "<tbody id='Nhom"+number+"'><tr><td colspan='5'><input name='nhomChucNang' type='text' class='form-control' required='required' placeholder='Nhập tên nhóm' data-bv-notempty='true' data-bv-notempty-message='Tên nhóm khác rỗng' >"+
