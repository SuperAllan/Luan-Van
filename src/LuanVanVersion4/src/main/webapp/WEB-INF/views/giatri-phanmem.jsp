...
<form action="${contextPath}/updateGiaTriPhanMem" method="get" role="form">
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td id="AUCP" class="text-right">${AUCP}</td>
	...
	<button type="submit" class="btn btn-primary" id="submitGiaTriPhanMem">Lưu</button>
</form>
