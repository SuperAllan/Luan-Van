...
<div class="row-fluid">
	<div class="form-group">
		<div class="btn-group-vertical tool" id="tool">
			<button type="button" class="btn" id="saveDiagram" disabled="disabled">
			...
			<button type="button" class="btn" id="new-diagram" data-toggle="tooltip" data-placement="left" title="Tạo mới">
				<i class="mdi-content-add-box"></i>
			</button>
			<button type="button" class="btn" id="list-actor" data-toggle="tooltip" data-placement="left" title="Danh sach actor">
				<i class="glyphicon glyphicon-list"></i>
			</button>
			<button type="button" class="btn" id="list-usecase" data-toggle="tooltip" data-placement="left" title="Danh sach usecase">
				<i class="glyphicon glyphicon-list"></i>
			</button>
			<button type="button" class="btn" id="list-diagram" data-toggle="tooltip" data-placement="left" title="Danh sach diagram">
				<i class="glyphicon glyphicon-list"></i>
			</button>
			<button type="button" class="btn tool-btn active" id="arrow">
				<img src="<c:url value="/resources/img/arrow.png" />" alt="arrow"/>
			</button>
			<button type="button" class="btn tool-btn" id="actor">
				<img src="<c:url value="/resources/img/actor.svg" />" alt="actor" width="24" height="24"/>
			</button>
			<button type="button" class="btn tool-btn" id="usecase">
				<img src="<c:url value="/resources/img/usecase.png" />" alt="usecase"/>
			</button>
			<a class="btn" data-toggle="modal" href='#modal-exportJSON'>
				JSON
			</a>
			<a class="btn" data-toggle="modal" href='#modal-exportXML'>
				XML
			</a>
			<a class="btn" data-toggle="modal" href='#modal-exportSVG'>
				SVG
			</a>
			<button type="button" class="btn" id="loadFile">
				Import
			</button>
			<a class="btn" data-toggle="modal" href='#modal-scoreActor' id="scoreActor">
				TAW
			</a>
			<a class="btn" data-toggle="modal" href='#modal-scoreUsecase' id="scoreUsecase">
				TBF
			</a>
		</div>
...
<div class="list-element-view">
	<div id="toggle-actor-view" style="background: url('/luanvan/resources/img/gauze.png'); padding: 0 20px 0 20px;">
		Actors <i class="glyphicon glyphicon-chevron-up pull-right"></i>
	</div>
	<div id="children-actor-view" style="padding: 5px 20px 5px 20px;">
	</div>
	<div id="toggle-usecase-view" style="background: url('/luanvan/resources/img/gauze.png'); padding: 0 20px 0 20px;">
		Usecases <i class="glyphicon glyphicon-chevron-up pull-right"></i>
	</div>
	<div id="children-usecase-view" style="padding: 5px 20px 5px 20px;">
	</div>
</div>
...
<div class="modal fade" id="modal-list-diagram">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Danh sách các so do</h4>
			</div>
			<div class="modal-body" >
