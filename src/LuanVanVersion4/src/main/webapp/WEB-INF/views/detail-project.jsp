...
<div class="container">
	<div class="panel panel-info content-home">
		<div class="panel-heading">Thông tin chi tiết</div> <a href="${contextPath}/downloadExcel/project=${project.tenproject}">Excel</a><br> <a href="${contextPath}/downloadPDF/project=${project.tenproject}">PDF</a><br><a href="${contextPath}/downloadDoc/project=${project.tenproject}">Doc</a>
				...
				<div class="col-md-10 wrapper-tab-content-detail-project">
					 <div class="tab-content">
				        ...
				        <div class="tab-Li tab-pane fade" id="tabGiaoDien">
				           ...
				           <%@ include file="/WEB-INF/views/diagramui.jsp" %>
				        </div>
