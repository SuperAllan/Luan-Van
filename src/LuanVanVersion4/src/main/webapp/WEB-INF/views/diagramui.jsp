...
<div id="tool-UI">
	<div class="btn-group-vertical" id="element-design-ui">
		...
		<button type="button" class="btn btn-default" id="assign-usecase-design-ui" data-toggle="tooltip" data-placement="left" title="Gán UC" style="border-bottom: 1px solid #0769AD;">
...
<div class="modal fade" id="modal-assignUI">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h4 class="modal-title">Gán giao diện vào usecase</h4>
			</div>
			<div class="modal-body" >
				<div class="row" id="body-assignUI">
				</div>
			</div>
			<div class="modal-footer">
				<button type="submit" class="btn btn-info" id="btn-assign-ui">
					<i class="glyphicon glyphicon-save"></i> OK</button>
			</div>
		</div>
	</div>
