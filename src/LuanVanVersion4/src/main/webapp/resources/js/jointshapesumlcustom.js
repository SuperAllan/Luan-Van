...
joint.shapes.uml.Actor = joint.shapes.basic.Generic.extend({
    ...
    defaults: joint.util.deepSupplement({
        ...
        description: "",
        attrs: {
            circle: { cx: 21, cy: 15, fill: "#fcfcfc", r: 10, stroke: "black", 'stroke-dasharray': "none", 'stroke-width': 2, fill: 'transparent' },
            '.name': { fill: 'black', y: 96, 'text-anchor': 'middle', x: 23, 'font-family': 'Arial', 'font-size': 16 },
            tspan: { x: 23 }
        },
        shapes: {
            ...
            text: { fill: 'black', y: 96, 'text-anchor': 'middle', x: 23 },
            tspan: { x: 23 }
        }
...
joint.shapes.uml.Usecase = joint.shapes.basic.Generic.extend({
	...
	defaults: joint.util.deepSupplement({
        ...
        group: "",
        attrs: {
            ellipse: { stroke: 'black', 'stroke-width': 2, rx : 40, ry: 16, fill: 'white', cx: 43, cy: 19 },
            '.name': { x: 42, y: 55, fill: 'black', 'text-anchor': 'middle', 'font-family': 'Arial', 'font-size': 16 },
            tspan: { x: 42 }
        },
        shapes: {
        	ellipse: { stroke: 'black', 'stroke-width': 2, rx : 40, ry: 16, fill: 'white', cx: 43, cy: 19 },
