...
<div class="panel panel-info content-home">
	...
	<div class="panel-body">
		...
		<div class="form-register-home col-md-4">
		        ...
		        <button type="submit" class="btn btn-info btn-lg btn-block"><i class="glyphicon glyphicon-hand-o-right"></i> Đăng kí ngay</button><br>
		   		<span style="color: black;">Sau khi đăng ký thành công mật khẩu sẽ được gửi qua Email của bạn.</span>
		     </form>
		</div>
		<div class="col-md-12">
