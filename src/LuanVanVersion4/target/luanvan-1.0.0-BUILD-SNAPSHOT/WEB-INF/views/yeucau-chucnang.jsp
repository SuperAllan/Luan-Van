			...
			<c:forEach items="${listNhomChucNangFromData}" var="listData">
				<tbody>
					 <tr class="well-material-green-100">
					 	<td colspan="5">
					 		<input name="nhomChucNang" class="form-control nhomChucNang well-material-green-100" required value="${listData.tennhom}">
						 ...
						 <tr>
						 	<td></td>
						 	<td><textarea name="listChucNang" rows="1" class="form-control" required >${listData2.motayeucau}</textarea></td>
						 	<td>
