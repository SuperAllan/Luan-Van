...
function themChucNang(id) {
	var tr = "<tr>"+
			"<td></td>"+
			"<td><textarea name='listChucNang' rows='1' class='form-control' required='required' placeholder='Mô tả chức năng' data-bv-notempty='true' data-bv-notempty-message='Mô tả khác rỗng'></textarea></td>"+
			"<td>"+
