...
<ul class="nav nav-tabs list-menu-uoc-luong">
  <li role="presentation" id ="chucNang" class="active"><a href="#tabChucNang" data-toggle="tab">I. Yêu cầu chức năng</a></li>
 <!--  <li role="presentation"><a href="#tabTacNhan" data-toggle="tab">Tác nhân</a></li>
  <li role="presentation"><a href="#tabUsecase" data-toggle="tab">Use-Case</a></li> -->
  ...
  <li role="presentation" id="bangLuong"><a href="#tabBangLuong" data-toggle="tab">Lương</a></li>
