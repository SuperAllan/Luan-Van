...
<div class="col-md-2 text-center">
    ...
    <div class="tabs-left">
		<ul class="nav nav-stacked tab-left">
	        <li class="classLi active" id="UC"><a href="#tabUC" data-toggle="tab"><i class="mdi-action-assessment"></i> Sơ đô Use Case</a></li>
	        <li class="classLi" id="uocLuong"><a href="#tabUocLuong" data-toggle="tab"><i class="mdi-editor-attach-money"></i>Ước lượng chi phí</a></li>
	        <li class="classLi" id="giaoDien"><a href="#tabGiaoDien" data-toggle="tab"><i class="mdi-hardware-desktop-windows"></i> Thiết kế giao diện</a></li>
	        <li class="classLi" id="thietLap"><a href="#tabThietLap" data-toggle="tab"><i class="mdi-action-perm-data-setting"></i> Thiết lập dự án</a></li>
	        <li class="classLi" id="xoaDuAn"><a href="#tabXoaDuAn" data-toggle="tab"><i class="mdi-content-clear"></i> Xóa dự án</a></li>
	    </ul>
	</div>
</div>
<div class="col-md-10">
