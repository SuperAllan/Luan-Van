      ...
      <form method="POST" action="/luanvan/uploadFile" role="form"  id="formUploadFile">
      	...
      	<div onclick="showDialog()" id="anhDaiDien">
      		<c:if test="${not empty user.image }">
      			<img src="<c:url value="${user.image}" />" style="height: 180px; width: 169px;">
      			
      		</c:if>
      		<c:if test="${empty user.image }">
      			<img src="<c:url value="/resources/img/hinh.svg" />" style="height: 180px; width: 169px;">
      		</c:if>
      		<div class="hoverImg" style="z-index: 10;color: #fff;background: rgba(34, 85, 85, 0.3); position: relative; top: -61px; width: 169px; padding: 20px 15px; ">
...
<div class="col-md-10">
	 <div class="tab-content">
								...
								<tr>
									<td>
											<a href="${contextPath}/detailProject/name=${list.tenproject}" >
												<span class="projectName">${list.tenproject}</span>
											</a>
        ...
        <div class="tab-pane fade" id="tabThongTin">
            <div class="panel panel-primary">
			  <div class="panel-heading" style="font-size: 20px">Thông tin cá nhân</div>
			  <div class="panel-body">
