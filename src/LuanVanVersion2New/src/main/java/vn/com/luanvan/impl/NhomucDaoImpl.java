...
public class NhomucDaoImpl implements NhomucDao {
	...
	@Transactional
	public boolean hasNhomuc(String tenNhom) {
		String sql = "from Nhomuc as a where a.tennhom = :tenNhom";
		Query query = sessionFactory.getCurrentSession().createQuery(sql);
	...
	@Transactional
	public Nhomuc getNhomucByName(String tenNhom) {
		String sql = "from Nhomuc as a where a.tennhom = :tenNhom";
		Query query = sessionFactory.getCurrentSession().createQuery(sql);
		query.setParameter("tenNhom", tenNhom);
	...
	public List<Nhomuc> getNhomucByProject(int projectId) {
		String sql = "from Nhomuc as a where a.projectId = :projectId";
		Query query = sessionFactory.getCurrentSession().createQuery(sql);
